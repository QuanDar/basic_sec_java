...
public class RSAencryptAES {
    ...
    public void testFirstVendorEncrypt()
        ...
        try {
            ...
            AESMessage aesCipher = new AESMessage();
            cipherText = aesCipher.encryptMessage(rawText, 1000, AESMessage.KeyLength.TWO_FIFTY_SIX);

            RSACipher rsaCipher = new RSACipher();
            encodedAESSecretKey = aesCipher.getEncodedSecretKey(aesCipher.getSecretKey());
            encryptedAESSecretKey = rsaCipher.encrypt(encodedAESSecretKey, rsaPublicKey);
    ...
    public void testSecondACMEDecrypt()
        ...
        try {
            ...
            RSACipher rsaCipher = new RSACipher();
            decryptedAESPrivateKey = rsaCipher.decrypt(encryptedAESSecretKey, rsaPrivateCrtKey);
